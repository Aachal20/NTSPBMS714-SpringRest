...
public class ProductMasterEntity {
	...
	public ProductMasterEntity(Integer productId, String designerName, Integer designerId, Integer categoryId,
			...
			Specification specifications, Boolean isActive, Boolean isDeleted, String createdBy, String updatedBy,
			String approvedBy, String sKQCode, String comments, String adminStatus) {
		super();
	...
	public String toString() {
		return "ProductMasterEntity [productId=" + productId + ", designerName=" + designerName + ", designerId="
				...
				+ specifications + ", isActive=" + isActive + ", isDeleted=" + isDeleted + ", createdBy=" + createdBy
				+ ", updatedBy=" + updatedBy + ", approvedBy=" + approvedBy + ", SKQCode=" + SKQCode + ", comments="
	...
	public ProductMasterEntity(Integer productId, String designerName, Integer designerId, Integer categoryId,
			...
			Boolean cod, Boolean customization, String priceType, Float taxPercentage, Boolean isActive,
			Boolean isDeleted, String createdBy, String updatedBy, String comments, String adminStatus) {
		super();
		this.productId = productId;
		this.designerName = designerName;
		this.designerId = designerId;
	...
	public void setProductId(Integer  l) {
		this.productId = l;
	}
	public String getDesignerName() {
		return designerName;
	...
	public String toString() {
		return "ProductMasterEntity [productId=" + productId + ", designerName=" + designerName + ", designerId="
				+ designerId + ", categoryId=" + categoryId + ", subcategoryId=" + subcategoryId + ", gender=" + gender
				+ ", productName=" + productName + ", productDescription=" + productDescription + ", age=" + age
				+ ", cod=" + cod + ", customization=" + customization + ", priceType=" + priceType + ", taxPercentage="
				+ taxPercentage + ", isActive=" + isActive + ", isDeleted=" + isDeleted + ", createdBy=" + createdBy
				+ ", updatedBy=" + updatedBy + ", comments=" + comments + ", adminStatus=" + adminStatus + "]";
	}
	*/
